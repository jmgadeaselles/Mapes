...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function restituir(idHistoric) {
            if (confirm('Restituir Foto amb històric id=' + idHistoric + '?')) {
                document.getElementById('FonsDetallHistoric').style.visibility = 'visible';
                document.getElementById('DetallHistoric').style.visibility = 'visible';
                $('#DetallHistoric').html('Loading...');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="BotoGuardar" runat="server" Text="Guardar" 
        PostBackUrl="~/admin/fotos/admin/Guardar.aspx" />
                ...
                <ItemTemplate>
                    ...
                    <asp:GridView ID="TaulaIdioma" runat="server" EnableModelValidation="True" OnRowDataBound="TaulaIdiomaRowDataBound">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkRestituir" CommandArgument='<%# eval("id") %>' runat="server">Restituir</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
